...
alias zconfig='sudo sublime ~/.zshrc'
alias zreset='source ~/.zshrc'
alias vconfig='sudo sublime ~/.vimrc'
...
plugins=(git autojump bower brew bundler cake chruby composer cloudapp coffee docker gem gitfast git-extras git-flow github grails httpie jsontools lavarel4 mysql-macports node npm pip python pylint rails redis-cli ruby sublime sudo web-search )
